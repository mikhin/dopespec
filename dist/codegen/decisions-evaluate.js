...
export const generateDecisionEvaluate = (def) => {
    ...
    lines.push(`export function evaluate${name}(input: ${name}Input): ${name}Output {`);
    ...
    const hasCatchAll = lastRule !== undefined && Object.keys(lastRule.when).length === 0;
    if (!hasCatchAll) {
...
//# sourceMappingURL=decisions-evaluate.js.map