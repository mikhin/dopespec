...
import { generateCommands, generateDecisionEvaluate, generateDecisionTable, generateDecisionTests, generateE2EStubs, generateEvents, generateInvariants, generateMermaid, generateOrchestrators, generateTests, generateTransitions, generateTypes, generateZod, } from "../codegen/index.js";
import { CreditTier, Customer, Order, Pet, PetAdoptionFee, } from "../examples/pet-store.js";
const models = [
...
function writeGenFiles(defs, generators, dir) {
    const paths = [];
    for (const d of defs) {
    ...
    it("all generated TypeScript compiles with strict tsc", () => {
        ...
        try {
            ...
            const errors = diagnostics.filter((d) => {
                ...
                if (msg.includes("Cannot find module 'vitest'") ||
            ...
            if (errors.length > 0) {
                const messages = errors.map((d) => {
                    ...
                    const line = d.file && d.start != null
...
//# sourceMappingURL=e2e-proof.test.js.map